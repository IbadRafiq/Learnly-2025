...
import { Mail, Lock, LogIn, Loader, UserCircle, Eye, EyeOff } from 'lucide-react'
        ...
        <div className="card-glass p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            <Link to="/" className="inline-block">
              <h1 className="text-4xl font-bold gradient-text hover:opacity-80 transition-opacity">
                LEARNLY
              </h1>
            </Link>
            <p className="text-gray-600 mt-2 font-medium">Virtual AI Co-Instructor Platform</p>
          </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {['student', 'teacher', 'admin'].map((roleOption) => (
                  <button
                    ...
                    className={`p-3.5 rounded-xl border-2 transition-all duration-200 ${role === roleOption
                  ...
                  >
                    ...
                    <p className="text-xs font-semibold capitalize">{roleOption}</p>
                  </button>
                ))}
              </div>
            </div>
